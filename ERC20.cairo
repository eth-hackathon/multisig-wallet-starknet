...
@view
func get_total_supply{storage_ptr : Storage*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (
        res : felt):
...
@view
func get_decimals{storage_ptr : Storage*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (
        res : felt):
...
@view
func allowance{storage_ptr : Storage*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
func _transfer{storage_ptr : Storage*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
